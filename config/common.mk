...
PRODUCT_COPY_FILES += \
    vendor/axxion/prebuilt/common/bin/otasigcheck.sh:system/bin/otasigcheck.sh
...
#ChameleonEngine
PRODUCT_COPY_FILES += \
    vendor/axxion/proprietary/ChameleonEngine/ChameleonEngine.apk:system/app/ChameleonEngine.apk
...
ifeq ($(RELEASE),true)
    ...
    AXXION_VERSION_STATE := UNOFFICIAL
    AXXION_VERSION := AXXION-v$(AXXION_VERSION_MAJOR).$(AXXION_VERSION_MINOR)-$(AXXION_VERSION_STATE)
endif
